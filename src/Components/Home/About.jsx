    ...
    return (
        <div className="mt-20 mb-8">
            <div className="w-2/3 mx-auto">
                <h1 className="text-[26px] mb-5 font-bold text-center text-[#e4cbfd]">Who I Am ?</h1>
                <h1 className="text-3xl font-bold text-center text-white">A passionate developer who loves to code</h1>
            </div>
